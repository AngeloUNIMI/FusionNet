function TestPCAOutput = computekNNClassificationPerformance(ftestPCA_all, ftestPCA_Wpca_all, TestPCALabels, sizeTest, distMatrix, stepPrint, numCoresKnn, param)
